...
\nomenclature[sdk]{\textbf{Software Developer Kit (SDK)}}{Un kit de desarrollador de software es una colección de herramientas y recursos que ayudan a los desarrolladores de software a crear, probar e implementar software. Los SDK pueden incluir desde muestras de código hasta herramientas de desarrollo.}
