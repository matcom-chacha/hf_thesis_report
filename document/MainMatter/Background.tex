...
\begin{enumerate}
	...
	%\nomenclature[nodeou]{\textbf{Node OUs}}}Las unidades organizativas de nodo son una forma de agrupar nodos en un tejido. Se utilizan para administrar el ciclo de vida de los nodos, incluido el inicio, la detención y la administración del estado de los nodos.}
